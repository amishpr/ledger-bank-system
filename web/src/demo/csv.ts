...
// Mirrors server/src/ledger/csv.ts, including the CRLF line ending and the
// oldest-first row order a downloaded record is naturally read in, even
// though the API and the on-screen table show newest-first.
